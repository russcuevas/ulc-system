            ...
            <div class="w-100" style="max-width: 450px;">
                ...
                <form class="needs-validation" novalidate>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-8">
                            <button type="submit"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    ...
                                    stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-log-in me-2">
                        ...
                        <!-- Back Button (Small Column) -->
                        <div class="col-4">
                            <a href="/" type="button"
                                class="btn btn-secondary w-100 d-flex justify-content-center align-items-center py-2 rounded-3 fw-medium shadow">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-reply me-2">
