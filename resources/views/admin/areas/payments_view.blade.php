        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('areas.payments.show', $area->id) }}" class="text-decoration-none"><i
                                class="fa-solid fa-coins me-1"></i> Payments - {{ $area->area_name }}</a></li>
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                ...
                if (!amount || !paymentType) {
                    Swal.showValidationMessage('Please enter amount and select payment type');
                }

                return { amount: amount, type: paymentType };
            }
        }).then((result) => {
