                ...
                <div class="card border-2 shadow-lg h-100 card-left-orange">
                    <div class="card-body">
                        ...
                        <span class="text-success small"><i class="bi bi-arrow-up"></i>
                            +₱{{ number_format($loansTrend, 2) }} over 2024</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-8">
                <div class="card border-2 shadow-lg h-100">
                    <div class="card-body">
                        ...
                        <span class="text-success small">Total this year: ₱<span
                                id="totalYearCollections">{{ number_format($totalYearCollections, 2) }}</span></span>
                            ...
                            <div class="d-flex gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <small class="text-body-secondary">
                                        {{ \Carbon\Carbon::parse($activity->created_at)->diffForHumans() }} by
                                        <span style="color: #ff6b35">{{ $activity->admin_name ?? 'System' }}</span>
                                    </small>
                                </div>
                            </div>
                        @endforeach
            ...
            document.getElementById('yearSelect').addEventListener('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        document.getElementById('totalYearCollections').textContent = response.total
